        ...
        if (err) { 
            ...
            if (userLogin.length > 0) {
                if (userLogin[0].GOOGLE === false) {
                    ...
                    var token = jwt.sign({user: userLogin[0]}, SEED, {expiresIn: 14400}); // expira en 4 horas
                ...
                request.query(lsql, (err, result) => {
                    if (err) { 
                        ...
                        if (ID_USER === 0) {
                            ...
                            var token = jwt.sign({user: userRegister[0]}, SEED, {expiresIn: 14400}); // expira en 4 horas
